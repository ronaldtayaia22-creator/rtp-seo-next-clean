...
const InteligenciaArtificialNavarra = ({ language }: Props) => {
  ...
  const adoptionSignals = isEs
    ? [
        'Tu equipo dedica demasiadas horas a tareas repetitivas de seguimiento o atención.',
        'Pierdes oportunidades por respuestas tardías o por falta de trazabilidad comercial.',
        'Tienes herramientas sueltas sin flujo unificado entre web, CRM y operación.',
      ]
    : [
  ...
  const roadmap = [
    {
        es: 'Fase 1: Diagnóstico de procesos y prioridad de negocio.',
      en: 'Phase 1: Process diagnosis and business priority.',
    },
    {
        es: 'Fase 2: Piloto acotado con alcance claro y métricas acordadas.',
      en: 'Phase 2: Scoped pilot with clear scope and agreed metrics.',
    },
    {
        es: 'Fase 3: Integración con operación real (CRM, agenda, seguimiento).',
      ...
      <div className="container mx-auto max-w-4xl">
        <header className="space-y-5 mb-14 animate-fade-in-up">
          <h1 className="text-3xl md:text-5xl font-bold text-glow-primary leading-tight">
            {isEs
              ? 'Inteligencia artificial en Navarra: guía práctica para empresas'
              : 'Artificial intelligence in Navarra: practical guide for businesses'}
          </h1>
          <p className="text-lg text-muted-foreground leading-relaxed">
            {isEs
              ? 'Esta página es informativa: explica qué es la IA aplicada a empresa, cuándo tiene sentido implantarla y cómo evitar errores frecuentes en la adopción.'
          ...
          <p className="text-muted-foreground leading-relaxed">
            {isEs
              ? <>Si quieres pasar de la teoría a una implantación real, revisa los <Link href="/servicios" className="text-primary hover:underline font-medium">servicios de IA para empresas en Navarra</Link>.</>
        ...
        <section className="mb-14 animate-fade-in-up" style={{ animationDelay: '0.08s' }}>
          <div className="flex items-center gap-3 mb-4 text-primary">
            ...
            <h2 className="text-2xl font-semibold text-foreground">
              {isEs ? 'Qué es la IA aplicada a empresas' : 'What AI applied to businesses means'}
            </h2>
          </div>
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              {isEs
                ? 'No es solo un chatbot. Es una capa de decisión y automatización que conecta canales de entrada, operaciones internas y seguimiento comercial.'
            ...
            <p>
              {isEs
                ? <>Cuando se diseña como sistema, la IA reduce fricción operativa y mejora la velocidad de respuesta en puntos críticos del negocio. El siguiente paso suele ser <Link href="/servicios" className="text-primary hover:underline font-medium">implantar sistemas de IA en empresa</Link> con alcance y prioridades claras.</>
        ...
        <section className="mb-14 animate-fade-in-up" style={{ animationDelay: '0.12s' }}>
          <div className="flex items-center gap-3 mb-4 text-primary">
            ...
            <h2 className="text-2xl font-semibold text-foreground">
              {isEs ? 'Cuándo implementarla' : 'When to implement it'}
            </h2>
          </div>
        ...
        <section className="mb-14 animate-fade-in-up" style={{ animationDelay: '0.16s' }}>
          <div className="flex items-center gap-3 mb-4 text-primary">
            ...
            <h2 className="text-2xl font-semibold text-foreground">
              {isEs ? 'Errores comunes en adopción' : 'Common adoption mistakes'}
            </h2>
          </div>
          <div className="space-y-3">
        ...
        <section className="mb-14 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          <div className="flex items-center gap-3 mb-4 text-primary">
            ...
            <h2 className="text-2xl font-semibold text-foreground">
              {isEs ? 'Roadmap de adopción recomendado' : 'Recommended adoption roadmap'}
            </h2>
          </div>
          ...
          <p className="text-sm text-muted-foreground">
            {isEs
              ? <>Si necesitas bajar esta hoja de ruta a ejecución, revisa los <Link href="/servicios" className="text-primary hover:underline font-medium">servicios de IA para empresas</Link>.</>
        ...
        <section className="p-8 rounded-2xl border border-primary/20 bg-primary/5 text-center space-y-4 animate-fade-in-up" style={{ animationDelay: '0.24s' }}>
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            {isEs
              ? 'Si ya tienes claridad sobre objetivos, ve a la página principal de servicios para definir alcance y propuesta de implantación.'
          ...
          <p className="text-sm text-muted-foreground">
            ...
            <Link href="/diagnostico-ia-navarra" className="text-primary hover:underline font-medium">
              {isEs ? 'contactar para un diagnóstico inicial' : 'contact us for an initial diagnosis'}
            </Link>
            .
          </p>
        </section>
