...
const ComoImplementarIANavarra = ({ language }: ArticleProps) => {
  ...
  const articleSchema = {
    ...
    "@type": "Article",
    "headline": "Cómo implementar inteligencia artificial en una empresa en Navarra",
    "description": "Guía paso a paso para implementar inteligencia artificial en empresas en Navarra y Pamplona: desde el análisis inicial hasta la optimización continua.",
        ...
        <div className="container mx-auto max-w-3xl">
          ...
          <div className="prose prose-invert max-w-none space-y-10 text-foreground/90 leading-relaxed text-base md:text-lg">
            ...
            <section>
              <p>
                {isEs
                  ? 'Muchas empresas en Navarra y en Pamplona saben que la inteligencia artificial puede ayudarles, pero no saben por dónde empezar. La buena noticia es que implementar IA no tiene por qué ser complicado ni caro si se hace con un plan claro.'
              ...
              <p className="mt-4">
                {isEs
                  ? 'En esta guía te explicamos los cinco pasos para implementar inteligencia artificial en tu empresa, los errores más comunes que debes evitar y cómo asegurarte de que la inversión genera resultados reales.'
            ...
            <section>
              ...
              <p>
                {isEs
                  ? 'El primer paso no es elegir una herramienta, sino entender tu negocio. ¿Dónde se pierde más tiempo? ¿Qué tareas se repiten cada día? ¿Dónde se escapan clientes por falta de respuesta?'
              ...
              <p className="mt-4">
                {isEs
                  ? 'Un diagnóstico estratégico permite identificar exactamente dónde la inteligencia artificial puede generar el mayor impacto con la menor inversión. Sin este análisis, se corre el riesgo de implementar soluciones que no resuelven los problemas reales del negocio.'
              ...
              <p className="mt-4">
                {isEs
                  ? 'Muchas empresas en Navarra cometen el error de implementar inteligencia artificial sin un análisis previo, lo que provoca resultados pobres y pérdida de inversión.'
            ...
            <section>
              ...
              <ul className="list-disc pl-6 mt-4 space-y-2">
                ...
                <li>{isEs ? 'Procesos de atención al cliente con preguntas frecuentes y respuestas predecibles.' : 'Customer service processes with frequent questions and predictable answers.'}</li>
                <li>{isEs ? 'Gestión de citas, reservas o pedidos que se hacen de forma manual.' : 'Appointment, reservation or order management done manually.'}</li>
                ...
                <li>{isEs ? 'Sincronización de datos entre plataformas que se hace de forma manual.' : 'Data synchronization between platforms done manually.'}</li>
              </ul>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4">
                {isEs ? 'Paso 3: Elegir la tecnología adecuada' : 'Step 3: Choose the right technology'}
              </h2>
              <p>
                {isEs
                  ? 'Una vez identificados los procesos, el siguiente paso es seleccionar la solución que mejor se adapta. No siempre se necesita la opción más avanzada. Lo importante es que la tecnología encaje con el negocio:'
              ...
              <ul className="list-disc pl-6 mt-4 space-y-2">
                <li>{isEs ? <><strong>Agentes de IA:</strong> para atención al cliente automatizada, captación de leads y soporte multicanal.</> : <><strong>AI agents:</strong> for automated customer service, lead capture and multichannel support.</>}</li>
                <li>{isEs ? <><strong>Automatización de procesos:</strong> para eliminar tareas manuales y conectar sistemas entre sí.</> : <><strong>Process automation:</strong> to eliminate manual tasks and connect systems together.</>}</li>
                <li>{isEs ? <><strong>Sistemas RAG:</strong> para que el agente acceda a la documentación interna de la empresa y dé respuestas precisas.</> : <><strong>RAG systems:</strong> so the agent can access internal company documentation and give accurate answers.</>}</li>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4">
                {isEs ? 'Paso 4: Integración con los sistemas actuales' : 'Step 4: Integration with current systems'}
              </h2>
              <p>
                {isEs
              ...
              <ul className="list-disc pl-6 mt-4 space-y-2">
                ...
                <li>{isEs ? 'Tu página web para ofrecer atención al cliente directa.' : 'Your website to offer direct customer service.'}</li>
                <li>{isEs ? 'WhatsApp y otros canales de mensajería.' : 'WhatsApp and other messaging channels.'}</li>
                <li>{isEs ? 'Tu ERP o sistema de gestión interna.' : 'Your ERP or internal management system.'}</li>
                <li>{isEs ? 'Herramientas de email marketing y seguimiento comercial.' : 'Email marketing and sales follow-up tools.'}</li>
              </ul>
              <p className="mt-4">
                {isEs
                  ? 'La integración es lo que convierte una herramienta aislada en un sistema que trabaja de forma continua para tu empresa.'
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4">
                {isEs ? 'Paso 5: Medición y optimización continua' : 'Step 5: Measurement and continuous optimization'}
              </h2>
              <p>
                {isEs
                  ? 'Implementar inteligencia artificial no es un proyecto que termina. Es un sistema que mejora con el tiempo. Después de ponerlo en marcha, es fundamental:'
              ...
              <ul className="list-disc pl-6 mt-4 space-y-2">
                <li>{isEs ? 'Medir los resultados: leads generados, tiempo ahorrado, conversiones, satisfacción del cliente.' : 'Measure results: leads generated, time saved, conversions, customer satisfaction.'}</li>
                <li>{isEs ? 'Ajustar las respuestas y los flujos del agente en función de los datos reales.' : 'Adjust agent responses and flows based on real data.'}</li>
            ...
            <section>
              ...
              <p>
                {isEs
                  ? 'Estas son las equivocaciones más frecuentes que cometen las empresas en Navarra al implementar IA:'
                  : 'These are the most frequent mistakes businesses in Navarra make when implementing AI:'}
              </p>
              <ul className="list-disc pl-6 mt-4 space-y-2">
                <li>{isEs ? <><strong>Empezar sin diagnóstico:</strong> implementar herramientas sin haber analizado antes qué problemas resolver.</> : <><strong>Starting without a diagnosis:</strong> implementing tools without first analyzing which problems to solve.</>}</li>
                <li>{isEs ? <><strong>Elegir la herramienta más cara:</strong> la mejor solución no siempre es la más compleja. A veces, una automatización sencilla genera más impacto que un sistema avanzado.</> : <><strong>Choosing the most expensive tool:</strong> the best solution isn&apos;t always the most complex. Sometimes a simple automation generates more impact than an advanced system.</>}</li>
                <li>{isEs ? <><strong>No integrar con los sistemas existentes:</strong> una solución de IA aislada pierde gran parte de su valor.</> : <><strong>Not integrating with existing systems:</strong> an isolated AI solution loses much of its value.</>}</li>
                ...
                <li>{isEs ? <><strong>Esperar demasiado para empezar:</strong> cada día sin automatización son clientes y oportunidades que se pierden frente a la competencia.</> : <><strong>Waiting too long to start:</strong> every day without automation means customers and opportunities lost to the competition.</>}</li>
              </ul>
            </section>
            ...
            <section>
              <p>
                {isEs
                  ? <>Si quieres ver qué opciones existen y cómo se adaptan a tu negocio, explora nuestras <Link href="/inteligencia-artificial-navarra" className="text-primary hover:underline font-medium">soluciones de inteligencia artificial en Navarra</Link> y descubre el sistema que mejor encaja con tu empresa.</>
            ...
            <section className="not-prose mt-16 p-4 sm:p-8 rounded-2xl border border-border bg-card text-center">
              <h2 className="text-2xl font-bold text-foreground mb-4">
                {isEs ? '¿Quieres saber cómo implementar IA en tu empresa?' : 'Want to know how to implement AI in your business?'}
              </h2>
              <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
                {isEs
                  ? 'Solicita un diagnóstico estratégico para saber cómo implementar IA en tu empresa.'
