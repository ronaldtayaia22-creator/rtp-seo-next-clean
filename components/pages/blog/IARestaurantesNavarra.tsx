...
const IARestaurantesNavarra = ({ language }: ArticleProps) => {
  ...
  const articleSchema = {
    ...
    "@type": "Article",
    "headline": "CÃ³mo aplicar inteligencia artificial en restaurantes de Navarra: guÃ­a prÃ¡ctica",
    "description": "Descubre cÃ³mo la inteligencia artificial puede ayudar a restaurantes en Navarra a gestionar reservas, responder clientes y automatizar tareas.",
    ...
    <>
        ...
        <div className="container mx-auto max-w-3xl">
          ...
          <h1 className="text-3xl md:text-5xl font-bold mb-6 text-foreground leading-tight">
            {isEs ? 'CÃ³mo aplicar inteligencia artificial en restaurantes de Navarra' : 'How to apply artificial intelligence in restaurants in Navarra'}
          </h1>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">
              {isEs ? 'CÃ³mo la inteligencia artificial estÃ¡ transformando los restaurantes' : 'How artificial intelligence is transforming restaurants'}
            </h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
              {isEs
                ? 'La hostelerÃ­a es uno de los sectores donde la inteligencia artificial puede generar un mayor impacto operativo. Los restaurantes gestionan diariamente decenas de reservas, consultas sobre el menÃº, horarios y disponibilidad, tareas que consumen tiempo y recursos del equipo.'
            ...
            <p className="text-muted-foreground leading-relaxed">
              {isEs
                ? <>Con la IA, los restaurantes en Navarra pueden automatizar estas gestiones, mejorar la experiencia del cliente y liberar al personal para centrarse en lo que realmente importa: la atenciÃ³n presencial y la calidad del servicio. Descubre todas las <Link href="/ia-restaurantes-navarra" className="text-primary hover:underline font-medium">soluciones de inteligencia artificial para restaurantes en Navarra</Link>.</>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">
              {isEs ? 'AutomatizaciÃ³n de reservas y atenciÃ³n al cliente' : 'Reservation automation and customer service'}
            </h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
              {isEs
                ? <>La <Link href="/automatizacion-procesos-empresas-navarra" className="text-primary hover:underline font-medium">automatizaciÃ³n de procesos</Link> en un restaurante permite gestionar reservas sin intervenciÃ³n humana. Un agente de IA puede recibir solicitudes de reserva a travÃ©s de la web, confirmar disponibilidad en tiempo real, enviar confirmaciones automÃ¡ticas y recordatorios antes de la fecha.</>
            ...
            <p className="text-muted-foreground leading-relaxed">
              {isEs
                ? 'AdemÃ¡s, el agente puede responder preguntas frecuentes como horarios de apertura, opciones para alÃ©rgenos, menÃºs del dÃ­a o disponibilidad para grupos, todo ello de forma inmediata y sin necesidad de que el personal del restaurante atienda el telÃ©fono.'
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">
              {isEs ? 'Agentes de IA para pÃ¡ginas web de restaurantes' : 'AI agents for restaurant websites'}
            </h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
              {isEs
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 space-y-3 text-muted-foreground">
              <li>{isEs ? <><strong>AtenciÃ³n al cliente 24/7:</strong> los clientes pueden consultar disponibilidad, ver el menÃº y reservar mesa en cualquier momento, incluso cuando el restaurante estÃ¡ cerrado.</> : <><strong>24/7 customer service:</strong> customers can check availability, view the menu and book a table at any time, even when the restaurant is closed.</>}</li>
              <li>{isEs ? <><strong>AutomatizaciÃ³n de reservas:</strong> el sistema gestiona reservas, confirmaciones y cancelaciones sin necesidad de atenciÃ³n manual.</> : <><strong>Reservation automation:</strong> the system manages bookings, confirmations and cancellations without manual attention.</>}</li>
              <li>{isEs ? <><strong>ReducciÃ³n de llamadas:</strong> al resolver las consultas mÃ¡s frecuentes de forma automÃ¡tica, el volumen de llamadas telefÃ³nicas se reduce significativamente.</> : <><strong>Fewer phone calls:</strong> by automatically resolving the most frequent inquiries, the volume of phone calls is significantly reduced.</>}</li>
              <li>{isEs ? <><strong>Mejora de la experiencia del cliente:</strong> respuestas inmediatas, atenciÃ³n personalizada y gestiÃ³n Ã¡gil generan una impresiÃ³n profesional y moderna.</> : <><strong>Better customer experience:</strong> immediate responses, personalized attention and agile management create a professional and modern impression.</>}</li>
              <li>{isEs ? <><strong>MÃ¡s tiempo para el servicio:</strong> el equipo del restaurante puede dedicar toda su atenciÃ³n al servicio en sala en lugar de gestionar consultas repetitivas.</> : <><strong>More time for service:</strong> the restaurant team can dedicate all their attention to table service instead of managing repetitive inquiries.</>}</li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              {isEs
                ? <>Los <Link href="/agentes-ia-atencion-cliente-navarra" className="text-primary hover:underline font-medium">agentes de IA para atenciÃ³n al cliente</Link> se adaptan perfectamente al sector de la hostelerÃ­a:</>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">
              {isEs ? 'CÃ³mo un restaurante en Navarra puede implementar IA' : 'How a restaurant in Navarra can implement AI'}
            </h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
              {isEs
